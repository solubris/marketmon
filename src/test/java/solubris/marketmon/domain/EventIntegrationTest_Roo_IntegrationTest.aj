...
import solubris.marketmon.domain.EventIntegrationTest;
...
privileged aspect EventIntegrationTest_Roo_IntegrationTest {
    ...
    public void EventIntegrationTest.testFindEvent() {
        ...
        Assert.assertEquals("Find method for 'Event' returned the incorrect identifier", id, obj.getEventId());
    }
    ...
    public void EventIntegrationTest.testMergeUpdate() {
        ...
        obj.flush();
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getEventId(), id);
