 ...
 *
 */
public class ReplacementRun implements MethodReplacer {
	@SuppressWarnings("unused")
	static private final Logger logger = LoggerFactory.getLogger(ReplacementRun.class);

	public ReplacementRun() {
		super();
	}
